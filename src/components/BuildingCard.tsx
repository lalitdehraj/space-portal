...
const FloorIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <path d="M10 5V10H9V5H5V13H9V12H10V17H9V14H5V19H12V17H13V19H19V17H21V21H3V3H21V15H19V10H13V15H12V9H19V5H10Z" fill="white" />
  </svg>
);
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 text-white">
        <div className={`flex items-center justify-between gap-4 rounded-md p-2 ${occupancyBgClass}`}>
          ...
          <div className="flex flex-col">
            <h4 className="mb-1 text-left text-sm font-bold">{building.name}</h4>
            <div className="flex items-center gap-2">
              <FloorIcon className="h-3 w-3 fill-white" />
              <p className="text-[10px]">Floors - {building.floors.length || 0}</p>
          ...
          {!Number.isNaN(occupancyRate) && building.totalOccupancy !== 0 && (
            <div className="flex flex-col items-center">
              ...
              <span className="text-lg font-bold">{`${occupancyRate}%` || "NA"}</span>
            </div>
          )}
        </div>
      </div>
