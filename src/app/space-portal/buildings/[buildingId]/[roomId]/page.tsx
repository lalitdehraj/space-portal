...
function RoomPage() {
  ...
  if (roomInfo?.isSitting) {
    ...
    const currentDate = startOfSelectedWeek.clone();
    while (currentDate.isSameOrBefore(endOfSelectedWeek, "day")) {
    ...
    weeklyOccupancy = maxMinutes > 0 ? (totalMinutes / maxMinutes) * 100 : 0;
  }
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      <h2 className="text font-md text-gray-600">{roomInfo.roomName ? roomInfo?.roomName : roomInfo?.id}</h2>
